...
def main():
    ...
    parser.add_argument('-o', '--output', required=False,
                        help='Output File Location EX: /Desktop/Somewhere/output.txt ')
    parser.add_argument('-H', '--hash', type=checkHash, required=False,
                        help='Single Hash EX: d41d8cd98f00b204e9800998ecf8427e')
    parser.add_argument('-k', '--key', type=checkKey, required=False, help='VT API Key EX: ASDFADSFDSFASDFADSFDSFADSF')
...
def VT_Request(key, hash, output):
    ...
    url = requests.get('https://www.virustotal.com/api/v3/file/report', params=params)
